...
export class MindConnectAgent extends AgentAuth {
    ...
    public async PostEvent(
        ...
        // const url = `${this.AgentManagementGateway()}${this.ServiceBaseUrl("mindconnect", "v3")}/exchange`;
        const url = `${this.AgentManagementGateway()}${this.ServiceBaseUrl("eventmanagement", "v3")}/events`;
